...
import Logo from '../assets/OpenGMS-logo-01.png'
    ...
    return (
        <footer className='grid gap-8 md:gap-0 text-gray-500 md:w-4/5 mx-auto mt-32 md:grid-cols-5'>
            ...
            <nav className='grid gap-2 content-start'>
                ...
                <p>注册注册注册</p>
                <input type="text" name='' id='' className='py-2 px-3 border' placeholder='您的邮箱' />
            </nav>
            <div className='col-span-full mt-12 border-t py-9 flex flex-col gap-4 justify-between md:flex-row'>
                <p>由{""}
                    <a href='https://geomodeling.njnu.edu.cn/' className='text-blue-500'>OpenGMS团队</a>
                    {""}提供技术支持. All Rights Reserved.
                </p>
